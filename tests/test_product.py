...
def test_product_quantity_validation():
    """Тест валидации количества при создании продукта"""
    ...
    # Проверка на положительное количество (не должно вызывать ошибку)
    try:
        product = Product("Test", "Description", 100.0, 10)
        assert product.quantity == 10
    except ValueError:
        pytest.fail("Продукт с положительным количеством не должен вызывать ошибку")
