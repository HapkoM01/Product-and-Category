...
def test_category_with_smartphone():
...
def test_category_with_grass():
    """Тест добавления газонной травы в категорию"""
    from src.lawn_grass import LawnGrass  # Изменено с Grass на LawnGrass
    ...
    grass = LawnGrass(  # Изменено с Grass на LawnGrass
        "Grass", "Desc", 50.0, 100,
